...
![](Query 2.png){style="COLOR:TEAL;" width="719" height="235"}

![](QR2.JPG)

> > ##### **WITNESS 2** {style="color: teal;"}

![](Query 3.png){width="719" height="235"}
...
![](Query 4.png){width="719" height="235"}
...
![](Query 5.png){width="719" height="235"}
...
![](Query 6.png){width="719" height="235"}
...
![](Query 7.png){width="719" height="235"}
