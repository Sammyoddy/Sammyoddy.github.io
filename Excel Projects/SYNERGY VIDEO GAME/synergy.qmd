...
![](SYNERGY PAGE.png){fig-align="left" width="350"}
...
The dataset used is sourced from [Kaggle](https://www.kaggle.com/datasets/gregorut/videogamesales){style="color:blue;"} and contains information on video games with sales exceeding 100,000 copies. It includes essential fields such as:
